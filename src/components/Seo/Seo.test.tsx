...
describe("SEO Component", () => {
  ...
  test("sets the meta description", () => {
    render(<Seo title="Test Page" description="This is a test description." />);
  ...
  test("creates and sets the Open Graph URL meta tag", () => {
    render(<Seo title="Test Page" url="https://example.com/test" />);
  ...
  test("updates existing meta tags instead of creating new ones", () => {
    ...
    render(<Seo title="Updated Title" description="New description" />);
    const metaDescription = document.querySelector("meta[name='description']");
